...
class TestPoint2:
    ...
    def test_connect(self):
        ...
        assert_equal(self.p10.connect(self.circle),
                     Segment2(self.p10, self.p11))
        assert_equal(self.circle.connect(self.p10),
...
class TestVector2:
    ...
    def test___add__(self):
        ...
        # Vector + Point -> Point
        assert_equal(self.v10+Point2(0, 1), Point2(1, 1))
        # Point + Point -> Vector
        assert_equal(Point2(1, 0)+Point2(0, 1), self.v11)
    ...
    def test___sub__(self):
        ...
        # Vector - Point -> Point
        assert_equal(self.v11-Point2(1, 0), Point2(0, 1))
        # Point - Point -> Vector
        assert_equal(Point2(1, 1)-Point2(1, 0), self.v01)
...
class TestArc2:
    ...
    def test_angle(self):
        ...
        assert_true(self.ap.angle() < radians(10))
        # check the angle is not the complementary angle
        assert_true(self.ap2.angle() < radians(10))
    ...
    def test___abs__(self):
        ...
        # check the angle is not the complementary angle
        assert_true(self.ap.length < 50)
        # check the angle is not the complementary angle
        assert_true(self.ap2.length < 50)
