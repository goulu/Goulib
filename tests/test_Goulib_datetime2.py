...
class TestDatef:
    def test_datef(self):
        ...
        assert_equal(datef(40179, fmt=None), date(year=2010, month=1, day=1))
        # http://answers.oreilly.com/topic/1694-how-excel-stores-date-and-time-values/
        assert_equal(datef(40179, fmt='Excel'),
...
class TestDatetimef:
    def test_datetimef(self):
        ...
        # http://answers.oreilly.com/topic/1694-how-excel-stores-date-and-time-values/
        assert_true(equal(datetimef(40179.503472, fmt=None), datetime(
...
class TestDaysgen:
    def test_daysgen(self):
        ...
        for d in daysgen(start, 10):
            pass
        assert_equal(d, datetime(year=1964, month=1,
                                 day=3, hour=12, minute=34, second=56))
        for d in daysgen(start, 15, onehour):
            pass
        assert_equal(d, datetime(year=1963, month=12,
