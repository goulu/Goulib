...
acadcolors=[
    ...
    '#4f3b00', '#4f4935', 'yellow', '#ffffaa', '#bdbd00', '#bdbd7e', '#818100', '#818156', 
    '#686800', '#686845', '#4f4f00', '#4f4f35', '#bfff00', '#eaffaa', '#8dbd00', '#adbd7e', 
    '#608100', '#768156', '#4e6800', '#5f6845', '#3b4f00', '#494f35', 'chartreuse', '#d4ffaa', 
    '#5ebd00', '#9dbd7e', '#408100', '#6b8156', '#346800', '#566845', '#274f00', '#424f35', 
    '#3fff00', '#bfffaa', '#2ebd00', '#8dbd7e', '#1f8100', '#608156', '#196800', '#4e6845', 
    '#134f00', '#3b4f35', 'lime', '#aaffaa', '#00bd00', '#7ebd7e', '#008100', '#568156', 
    '#006800', '#456845', '#004f00', '#354f35', '#00ff3f', '#aaffbf', '#00bd2e', '#7ebd8d', 
    '#00811f', '#568160', '#006819', '#45684e', '#004f13', '#354f3b', 'springgreen', '#aaffd4', 
    '#00bd5e', '#7ebd9d', '#008140', '#56816b', '#006834', '#456856', '#004f27', '#354f42', 
    '#00ffbf', '#aaffea', '#00bd8d', '#7ebdad', '#008160', '#568176', '#00684e', '#45685f', 
    '#004f3b', '#354f49', 'aqua', '#aaffff', '#00bdbd', '#7ebdbd', '#008181', '#568181', 
    '#006868', '#456868', '#004f4f', '#354f4f', 'deepskyblue', '#aaeaff', '#008dbd', '#7eadbd', 
    ...
    '#00134f', '#353b4f', 'blue', '#aaaaff', '#0000bd', '#7e7ebd', '#000081', '#565681', 
    ...
    '#3b004f', '#49354f', 'magenta', '#ffaaff', '#bd00bd', '#bd7ebd', '#810081', '#815681', 
